...
public class JpushClientUtil {
	public static Logger log = Logger.getLogger(JpushClientUtil.class);
    private final static String appKey = "a07fb7f9baae646f37e316df";
    private final static String masterSecret = "d16adfac6aeb32ae6f95192c";
